...
The question is not whether the analyst arrived with a perspective. All analysts do. The question is whether the perspective is held accountable to the text, and whether the text is permitted to resist.
...
3. **Falsification is operationalised.** Every task includes explicit criteria under which the reading fails. The text can resist.

4. **The lens is named.** "Mismatch as experiential structure" is transparent. We're not pretending we don't have one.
...
|---------------|---------------------|
| Recognition initiated this inquiry | ADHD is "the" framework for understanding Case |
| Mismatch is a testable structure | Case "has" ADHD |
| Lived experience is a legitimate heuristic | Our perspective is neutral |
| The text can resist interpretation | We've achieved pure description |
| The reading must be accountable to evidence | The reading is proven before testing |

---

## Track B vs Track C Usage

### Track B (Standalone Essay)
Compress to one paragraph or footnote. Core moves:
- "This analysis begins from recognition, not neutrality"
- "The structure must be rendered in the text to hold"
- "Discipline lies in testing"

Can omit explicit phenomenology citations.

### Track C (Academic Paper)
Full version, possibly expanded with citations to:
- Merleau-Ponty on situated perception
...
*Status: Pressure-tested against hostile Reviewer #3*
